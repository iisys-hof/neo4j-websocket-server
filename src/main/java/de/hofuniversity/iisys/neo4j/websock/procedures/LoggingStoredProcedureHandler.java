 ...
 */
public class LoggingStoredProcedureHandler
{
     ...
     */
    public LoggingStoredProcedureHandler(GraphDatabaseService database,
        ImplUtil impl)
    {
    ...
    public WebsockQuery storeProcedure(WebsockQuery query)
    {
        ...
        IStoredProcedure procedure = new LoggingCypherProcedure(name, fDb, statement);
